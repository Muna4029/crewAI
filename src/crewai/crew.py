...
class Crew(FlowTrackable, BaseModel):
    ...
    _user_memory: InstanceOf[UserMemory] | None = PrivateAttr()
    ...
    user_memory: InstanceOf[UserMemory] | None = Field(
        default=None,
    ...
    def train(
        self, n_iterations: int, filename: str, inputs: dict[str, Any] | None = {}
    ) -> None:
    ...
    async def kickoff_async(self, inputs: dict[str, Any] | None = {}) -> CrewOutput:
