    ...
    def plot(self, filename):
        ...
        try:
            ...
            try:
                ...
                raise OSError(f"Failed to save flow visualization to {filename}.html: {e!s}")
    ...
    def _generate_final_html(self, network_html):
        ...
        try:
            ...
            if not os.path.exists(logo_path):
                raise OSError(f"Logo file not found: {logo_path}")
            ...
            raise OSError(f"Failed to generate visualization HTML: {e!s}")
