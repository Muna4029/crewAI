...
class Agent(BaseAgent):
    ...
    fallback_llms: list[str | InstanceOf[BaseLLM] | Any] | None = Field(
    ...
    def set_knowledge(self, crew_embedder: dict[str, Any] | None = None):
        try:
            ...
            raise ValueError(f"Invalid Knowledge Configuration: {e!s}")
    ...
    def _execute_with_timeout(self, task_prompt: str, task: Task, timeout: int) -> str:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            try:
                ...
                future.cancel()
                raise RuntimeError(f"Task execution failed: {e!s}")
